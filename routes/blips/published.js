    ...
    config: {
        ...
        handler: (request, reply) => {
            ...
            if (Accept.parseAll(request.headers).mediaTypes.includes('text/html')) {
                ...
                reply.view(`blips/published`, _.merge(request.pre.features, {
                    title: `Blip - Published`,
        ...
        description: 'Retrieve the publication that this blip was published to ',
        notes: 'Returns a publication object',
        plugins: {
            'hapi-swagger': {
                responses: {
                    'default': {
