...
const meetings = {
    method: 'GET',
    path: '/radar/meetings/{date}/attended',
    config: {
        pre: [
            {
        ...
        handler: (request, reply) => {
            ...
            if (Accept.parseAll(request.headers).mediaTypes.includes('text/html')) {
                reply.view('meetings/attended', {
                    title: `Meeting - ${request.params.date} - Attended`,
        ...
        description: 'Retrieve info on a meeting and or nodes related to it',
